...
namespace BookStore
{
    ...
    public class ApplicationDbInitializer : DropCreateDatabaseAlways<ApplicationDbContext>
    {
        ...
        {
            InitializeIdentityRoles(context);
            base.Seed(context);
        }

        public static void InitializeIdentityRoles(ApplicationDbContext db)
        {
            ...
            var admin = new ApplicationUser { Email = "admin@mail.net", UserName = "admin@mail.net" };
